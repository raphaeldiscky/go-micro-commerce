...
// MarshalGQL implements graphql.Marshaler interface for PaymentMethod.
...
// UnmarshalGQL implements graphql.Unmarshaler interface for PaymentMethod.
func (p *PaymentMethod) UnmarshalGQL(v interface{}) error {
	...
	// Convert uppercase GraphQL value to lowercase Go value
	*p = PaymentMethod(strings.ToLower(str))
