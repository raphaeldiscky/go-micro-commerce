...
const (
	...
	ConsumerGroupNotificationUserEvents = "fulfillment-service.user-events" // For user lifecycle
	// ConsumerGroupNotificationOrderEvents is the consumer group for order events.
	ConsumerGroupNotificationOrderEvents = "fulfillment-service.order-events" // For order lifecycle
)
