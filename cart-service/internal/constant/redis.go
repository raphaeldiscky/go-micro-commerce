...
const (
	// CreateCartTTL is the time-to-live for create cart locks.
	CreateCartTTL = 10 * time.Second
	// CreateCartRetryInterval is the retry interval for creating carts.
	CreateCartRetryInterval = 500 * time.Millisecond
	// CreateCartRetryLimit is the maximum number of retries for creating carts.
	CreateCartRetryLimit = 3
)
