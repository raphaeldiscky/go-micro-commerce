...
// publisher, asynq worker) in a single process. It binds no request/response
// endpoint and registers nothing with Consul.
func newWorkerCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "worker",
		Short: "Run the async workers (kafka consumer, outbox, asynq)",
