...
const file_proto_product_proto_rawDesc = "" +
	"\n" +
	"\x13proto/product.proto\x12\x0emarketplace.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf7\x01\n" +
	"\aProduct\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05price\x18\x03 \x01(\x01R\x05price\x12\x1b\n" +
	"\tseller_id\x18\x04 \x01(\tR\bsellerId\x12\x1f\n" +
	...
	"\tseller_id\x18\x03 \x01(\tR\bsellerId\"J\n" +
	"\x15CreateProductResponse\x121\n" +
	"\aproduct\x18\x01 \x01(\v2\x17.marketplace.v1.ProductR\aproduct\"#\n" +
	"\x11GetProductRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"G\n" +
	"\x12GetProductResponse\x121\n" +
	"\aproduct\x18\x01 \x01(\v2\x17.marketplace.v1.ProductR\aproduct\"F\n" +
	...
	"\rCreateProduct\x12$.marketplace.v1.CreateProductRequest\x1a%.marketplace.v1.CreateProductResponse\x12S\n" +
	"\n" +
	"GetProduct\x12!.marketplace.v1.GetProductRequest\x1a\".marketplace.v1.GetProductResponse\x12Y\n" +
	"\fListProducts\x12#.marketplace.v1.ListProductsRequest\x1a$.marketplace.v1.ListProductsResponse\x12\\\n" +
	"\rUpdateProduct\x12$.marketplace.v1.UpdateProductRequest\x1a%.marketplace.v1.UpdateProductResponse\x12\\\n" +
	"\rDeleteProduct\x12$.marketplace.v1.DeleteProductRequest\x1a%.marketplace.v1.DeleteProductResponseB@Z>github.com/raphaeldiscky/go-ddd-template/proto/marketplace/v1;marketplacev1b\x06proto3"
...
var file_proto_product_proto_goTypes = []any{
	(*Product)(nil),               // 0: marketplace.v1.Product
	(*CreateProductRequest)(nil),  // 1: marketplace.v1.CreateProductRequest
	(*CreateProductResponse)(nil), // 2: marketplace.v1.CreateProductResponse
	(*GetProductRequest)(nil),     // 3: marketplace.v1.GetProductRequest
	(*GetProductResponse)(nil),    // 4: marketplace.v1.GetProductResponse
	(*ListProductsRequest)(nil),   // 5: marketplace.v1.ListProductsRequest
	(*ListProductsResponse)(nil),  // 6: marketplace.v1.ListProductsResponse
	(*UpdateProductRequest)(nil),  // 7: marketplace.v1.UpdateProductRequest
	(*UpdateProductResponse)(nil), // 8: marketplace.v1.UpdateProductResponse
	(*DeleteProductRequest)(nil),  // 9: marketplace.v1.DeleteProductRequest
	(*DeleteProductResponse)(nil), // 10: marketplace.v1.DeleteProductResponse
	(*timestamppb.Timestamp)(nil), // 11: google.protobuf.Timestamp
}
var file_proto_product_proto_depIdxs = []int32{
	11, // 0: marketplace.v1.Product.created_at:type_name -> google.protobuf.Timestamp
	11, // 1: marketplace.v1.Product.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 2: marketplace.v1.CreateProductResponse.product:type_name -> marketplace.v1.Product
	0,  // 3: marketplace.v1.GetProductResponse.product:type_name -> marketplace.v1.Product
	0,  // 4: marketplace.v1.ListProductsResponse.products:type_name -> marketplace.v1.Product
	0,  // 5: marketplace.v1.UpdateProductResponse.product:type_name -> marketplace.v1.Product
	1,  // 6: marketplace.v1.ProductService.CreateProduct:input_type -> marketplace.v1.CreateProductRequest
	3,  // 7: marketplace.v1.ProductService.GetProduct:input_type -> marketplace.v1.GetProductRequest
	5,  // 8: marketplace.v1.ProductService.ListProducts:input_type -> marketplace.v1.ListProductsRequest
	7,  // 9: marketplace.v1.ProductService.UpdateProduct:input_type -> marketplace.v1.UpdateProductRequest
	9,  // 10: marketplace.v1.ProductService.DeleteProduct:input_type -> marketplace.v1.DeleteProductRequest
	2,  // 11: marketplace.v1.ProductService.CreateProduct:output_type -> marketplace.v1.CreateProductResponse
	4,  // 12: marketplace.v1.ProductService.GetProduct:output_type -> marketplace.v1.GetProductResponse
	6,  // 13: marketplace.v1.ProductService.ListProducts:output_type -> marketplace.v1.ListProductsResponse
	8,  // 14: marketplace.v1.ProductService.UpdateProduct:output_type -> marketplace.v1.UpdateProductResponse
	10, // 15: marketplace.v1.ProductService.DeleteProduct:output_type -> marketplace.v1.DeleteProductResponse
