...
var file_fulfillment_proto_depIdxs = []int32{
	...
	1, // 4: fulfillment.FulfillmentService.GetShippingCost:input_type -> fulfillment.GetShippingCostRequest
	8, // 5: fulfillment.FulfillmentService.Health:input_type -> google.protobuf.Empty
	2, // 6: fulfillment.FulfillmentService.GetShippingCost:output_type -> fulfillment.GetShippingCostResponse
	7, // 7: fulfillment.FulfillmentService.Health:output_type -> fulfillment.HealthResponse
