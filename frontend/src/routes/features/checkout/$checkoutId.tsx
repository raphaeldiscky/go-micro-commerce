...
export const Route = createFileRoute('/features/checkout/$checkoutId')({
  component: CheckoutPageWithId,
})

function CheckoutPageWithId() {
  const navigate = useNavigate()
  const params = useParams({ from: '/features/checkout/$checkoutId' })
  ...
  if (checkoutSession && checkoutSession.id !== checkoutId) {
